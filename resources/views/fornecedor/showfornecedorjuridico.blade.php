...
<h2 class="subtitle-data">Dados</h2>
	<table class="table table-striped table-bordered table-hover table-data">
			<tr>
				<td class="col-md-2"><strong>Razão Social</strong></td>
				<td class="col-md-7">{{$fornecedorjuridico->razaosocial}}</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="col-md-2"><strong>CNPJ</strong></td>
				<td class="col-md-7">{{$fornecedorjuridico->cnpj}}</td>
			</tr>
	</table>
	...
	<nav class="btn-list">
			...
			<a href="{{route('fornecedor.fornecedores')}}" class="btn btn-danger">Excluir</a>
	</nav>
